...
```{r, echo=FALSE}
# Color Chart in R
# (Tested in R version 3.1.2)
#
# Earl F Glynn
# UMKC Center for Health Insights
# 2013-12-30 Store in GitHub.
# 2015-02-07 Create .Rmd version
#
...
```
See .Rmd file for how to create contrasting colors for labels in color boxes below.

## Matrix of R colors in index number order
...
## Matrix of R colors in hue order
...
Create 7-page color chart showing rectangle blocks of color, along with
